  ...
  return (
    <div className="max-w-6xl mt-2 ml-2">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {isAdminOrTrainer && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 text-center hover:shadow-md transition-shadow h-72 flex flex-col justify-center">
            ...
            <h3 className="text-xl font-bold text-gray-900 mb-2">Available Datasets</h3>
            <p className="text-gray-500 mb-6 text-sm">View list of available datasets for assessments.</p>
            <button
        ...
        {isAdminOrTrainer && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 text-center hover:shadow-md transition-shadow h-72 flex flex-col justify-center">
            ...
            <button
              onClick={() => navigate('/create-assessment?from=sql-playground')}
              className="w-full bg-gray-100 hover:bg-gray-200 text-gray-700 font-semibold py-2.5 px-5 rounded-lg transition-colors text-sm"
            >
              Create
            </button>
        ...
        {isAdminOrTrainer && (
          <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 text-center hover:shadow-md transition-shadow h-72 flex flex-col justify-center">
            ...
            <p className="text-gray-500 mb-6 text-sm">View details of all registered users and cohorts.</p>
            <button
